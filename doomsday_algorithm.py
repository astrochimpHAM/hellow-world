...
"""
Change how the program asks the user the date:
    
    Day -> Month -> Year

as three seperate inputs. This will keep the user from being confused by the
DD MM YYYY format that can be inconsistent across countries.
